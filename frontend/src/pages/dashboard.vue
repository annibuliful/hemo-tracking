...
<div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-4">
        <card-component icon="https://i.imgur.com/Lpr9rrw.png" title="บันทึกการฉีดยา" link="/injection" color="#66bb6a"/>
      </div>
      <div class="col-4">
        <card-component icon="https://i.imgur.com/UUWScH1.png" title="บันทึกอาการเลือดออก" link="/" color="#ffa000"/>
      </div>
      <div class="col-4">
      ...
      <div class="col-4">
        <card-component icon="https://i.imgur.com/hcaoriN.png" title="สิทธิขั้นตอน" link="/" color="#ffd54f"/>
      </div>
      <div class="col-4">
