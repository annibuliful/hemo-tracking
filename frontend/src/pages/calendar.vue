      ...
      <template slot-scope="props">
          <div v-for="(event, index) in props.showEvents" class="event-item" :key="index">
            ...
            <div v-if="event.type === 'life'">
              ...
              <p class="life-detail"><span class="life-level">ความเจ็บปวด:</span> <PainLevel :level="event.painLevel"/></p>
              <p class="life-detail"><span class="life-level">กิจกรรมที่ทำประจำ:</span> <ActivityLevel :level="event.activityLevel"/></p>
              <p class="life-detail"><span class="life-level">การเคลื่อนไหว:</span> <MovementLevel :level="event.movementLevel"/></p>
              <p class="life-detail"><span class="life-level">การดูแลตัวเอง:</span> <TakeCareLevel :level="event.takecareLevel"/></p>
              <p class="life-detail"><span class="life-level">ความเครียด:</span> <StressedLevel :level="event.stressedLevel"/></p>
            </div>
          </div>
        </template>
</vue-event-calendar>
