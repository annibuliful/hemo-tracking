...
<div class="container">
  ...
  <div class="row ignore-screen level">
    <div class="col-6 ignore-screen level-item">
      <img class="inline" src="../assets/man-doctor.png">
    </div>
    <div class="col-6 ignore-screen level-item">
      <img class="inline" src="../assets/woman-doctor.png">
    </div>
  </div>
  <div class="row ignore-screen level">
  ...
  <div class="col-12">
    ...
    <p style="text-align:center; text-decoration: underline; cursor: pointer">
      <router-link to="/reg">สมัครสมาชิก</router-link>
    </p>
